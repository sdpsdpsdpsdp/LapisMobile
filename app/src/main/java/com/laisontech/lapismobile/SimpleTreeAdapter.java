...
public class SimpleTreeAdapter extends TreeListViewAdapter{
    public SimpleTreeAdapter(Context context, ListView tree, List<Node> nodes, int defaultExpandLevel, int iconExpand, int iconUnExpand) {
        super(context, tree, nodes, defaultExpandLevel, iconExpand, iconUnExpand);
    }

    @Override
    protected View getConvertView(final Node node, int position, View convertView, ViewGroup parent) {
